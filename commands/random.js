...
module.exports = {
  ...
  async execute(senderId, args, pageAccessToken) {
    ...
    // dito ung ano url ng random vid
    ...
    try {
      ...
      console.error("Error in sending random video:", error);
      await sendMessage(senderId, {
        text: "⚠️ An error occurred while sending the video. Please try again later."
      }, pageAccessToken);
    }
  }
};
